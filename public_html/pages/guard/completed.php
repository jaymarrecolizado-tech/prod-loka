...
<div class="w-full px-4 py-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            ...
            <p class="text-base-content/60 mb-0">View all completed trips for reference</p>
        </div>
        <div>
            <a href="?page=guard" class="loka-btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="text-base-content/60 mb-1">With Documents</h6>
        ...
        <div class="card-body">
            <form method="GET" class="flex flex-wrap items-end gap-3">
                ...
                <div>
                    ...
                    <input type="date" class="loka-form-input" name="start_date" value="<?= $startDate ?>">
                </div>
                <div>
