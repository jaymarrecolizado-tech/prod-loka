...
<div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden mt-6 mb-6">
    <!-- Header -->
    ...
    <div class="p-6">
        ...
        <?php else: ?>
            ...
            <div class="flex items-center justify-center mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 border-b-2 border-green-500 inline-block">VERIFIED</h2>
                </div>
            </div>

            <div class="space-y-4">
                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 shadow-sm flex justify-between items-center">
                    <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-1">Voucher Number</p>
                        <p class="text-lg font-bold text-red-600"><?= e($voucher->voucher_no) ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-1">Request Date</p>
                        <p class="font-medium text-gray-900"><?= date('M d, Y', strtotime($voucher->request_date)) ?></p>
                    </div>
                </div>
                ...
                <div class="p-4 bg-blue-50 bg-opacity-50 rounded-xl border border-blue-50 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-2">
                        ...
                        <div class="text-sm font-bold text-gray-800"><?= e(strtoupper($voucher->driver_name)) ?></div>
                    </div>
                    
                    <div class="grid grid-cols-2 gap-2">
                        <div class="text-xs text-gray-500 uppercase">Plate No:</div>
                        <div class="text-sm font-bold text-gray-800"><?= e(strtoupper($voucher->vehicle_plate)) ?></div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-orange-50 bg-opacity-50 rounded-xl border border-orange-50 shadow-sm">
                    ...
                    <div class="flex items-end justify-between">
                        <div>
                            <div class="text-xs text-gray-500 uppercase mb-1">Fuel Type</div>
                            <div class="text-lg font-bold text-gray-800"><?= e(strtoupper($voucher->fuel_type)) ?></div>
                        </div>
                        <div class="text-right">
                            <div class="text-xs text-gray-500 uppercase mb-1">Quantity</div>
